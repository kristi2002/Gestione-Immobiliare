/**
 * Scheda Inquilino — pure config constants (stateless).
 */

export const API        = 'api/tenants.php';
...
export const PAY_STATUS    = { pending: 'In attesa', paid: 'Pagato', late: 'In ritardo', cancelled: 'Annullato' };
export const PAY_COLOR     = { pending: '#d97706', paid: '#16a34a', late: '#dc2626', cancelled: '#94a3b8' };
