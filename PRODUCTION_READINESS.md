...
**Stack:** PHP 8.x + MySQL + Apache (MAMP / hosting condiviso / VPS)

---

## Sommario esecutivo

L'app è **funzionale per uso interno** (dashboard, proprietari, immobili, documenti, email, promemoria, social, inquilini, impostazioni). La base di sicurezza è stata avviata (login, API protette, `.env`, cron con secret), ma **non è ancora pronta per la produzione** senza completare configurazione, hardening e procedure operative.
...
| Integrazioni (email, WhatsApp, Meta) | ⚠️ Da configurare |
| Backup & disaster recovery | ⚠️ Parziale |
| Deploy & documentazione | ❌ Da fare |
