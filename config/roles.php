...
const ROLE_PERMISSIONS = [
    'super_admin' => ['*'],
    'admin'       => ['dashboard','clients','leads','properties','contracts','documents','payments','expenses','invoices','communications','appointments','calendar','map','reminders','tenants','keys','agents','reports','social','settings','pdf','buildings','insurance','meters','suppliers','inventory','commissions','surveys','forecast','maintenance_workflow','whatsapp_inbox','property_applications'],
    'agent'       => ['dashboard','clients','leads','properties','contracts','documents','payments','expenses','communications','appointments','calendar','map','reminders','tenants','keys','pdf','buildings','insurance','meters','suppliers','inventory','surveys','maintenance_workflow','whatsapp_inbox','property_applications'],
    'readonly'    => ['dashboard','clients','leads','properties','contracts','documents','payments','expenses','communications','appointments','calendar','map','reminders','tenants','buildings','insurance','meters','suppliers','inventory','surveys','forecast','property_applications'],
];
