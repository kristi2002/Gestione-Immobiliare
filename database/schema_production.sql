...
CREATE TABLE `appointments` (
  ...
  `appointment_type` enum('visita','acquisizione','atto','chiamata') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'visita',
  `appointment_date` datetime NOT NULL,
  `duration_minutes` int NOT NULL DEFAULT '60',
  `location_type` enum('immobile','agenzia','virtuale') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'immobile',
  `location_detail` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `idx_appt_reminder` (`reminder_id`),
  CONSTRAINT `fk_appt_reminder` FOREIGN KEY (`reminder_id`) REFERENCES `reminders` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE `properties` (
  ...
  `locali` smallint unsigned DEFAULT NULL,
  `total_floors` smallint unsigned DEFAULT NULL,
  `energy_class` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `terraces` smallint unsigned DEFAULT NULL,
  `garden` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `parking_spaces` smallint unsigned DEFAULT NULL,
  `condition_state` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `exposure` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `reminders` (
  ...
  CONSTRAINT `fk_reminders_lead` FOREIGN KEY (`lead_id`) REFERENCES `leads` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
