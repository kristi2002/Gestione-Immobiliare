...
(1, 'Alessandro', 'Gatti', 'alessandro.gatti@gmail.com', '+39 333 901 2345', 'Impiegato stabile in azienda multinazionale. Referenze ottime. Pagamenti quasi sempre in anticipo. Ha segnalato problema caldaia a giugno 2024.', 'active'),
(2, 'Valentina', 'Moretti', 'valentina.moretti@gmail.com', '+39 347 802 3456', 'Insegnante scuola media. Inquilina silenziosa, mantiene l\'immobile in buone condizioni. Lieve ritardo a marzo per problema bancario.', 'active'),
(3, 'Carlo', 'Ferretti', 'carlo.ferretti@modaferretti.it', '+39 011 703 4567', 'Titolare negozio abbigliamento "Moda Ferretti". Puntuale nei pagamenti. Chiede ampliamento spazi nel 2025.', 'active'),
(4, 'Maria', 'Pellegrini', 'maria.pellegrini@libero.it', '+39 051 604 5678', 'Contratto scaduto. Ha rilasciato l\'immobile in buone condizioni. Deposito restituito integralmente.', 'inactive');
